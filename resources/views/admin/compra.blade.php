...
<div class="container">
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1> <span class="glyphicon glyphicon-cog" aria hidden="true"></span> Panel de Control  <small> Compra de boletos</small></h1>
          </div>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    ...
    <section id="breadcrumb">
      ...
      <div class="container">
        <ol class="breadcrumb">
         <li class="active"> Panel de Control / Compra de Boletos </li>
        </ol>
      </div>
